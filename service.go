...
// func (sv *Service) On(eventName EventName, cond ...handler.Condition) *handler.EventHandler {
// 	h := handler.EventHandler{}
// 	h.AddPrecondition(func(c *handler.Context) bool {
// 		v, exist := getEventField(c.Event, "GroupId")
// 		if exist {
...
// 	return sv.On(EVENT_NAME_MESSAGE, cond...)
// }
